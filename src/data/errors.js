...
export const errorEntries = [
  {
    ...
    product: "Laserfiche Repository Server / Client",
    versions: ["Version 9", "Version 12 docs"],
    confidence: "high",
  ...
  },
  {
    ...
    product: "Laserfiche Repository Server / Directory Server",
    versions: ["Version 10", "Version 10.1", "Version 12 docs"],
    confidence: "medium",
    reviewedDate: "2026-06-27",
    summary:
  ...
  },
  {
    ...
    product: "Laserfiche Repository Server",
    versions: ["Version 12 docs"],
    confidence: "low",
    reviewedDate: "2026-06-27",
