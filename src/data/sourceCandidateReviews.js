export const sourceCandidateReviews = {
  ...
  "https://answers.laserfiche.com/questions/77677/Error-42000-Permission-Denied-in-database-master": {
    entryId: "forms-sql-create-database-permission-42000",
    disposition: "accepted-fix",
    sourceType: "answers-community-confirmed",
    title: "Error 42000: Permission Denied in database 'master'",
    note: "Reviewed candidate accepted. Error 42000: Permission Denied in database 'master' was promoted from the Forms/Workflow candidate batch.",
    reviewStatus: "curated",
    productTags: ["Forms", "Version 9", "Version 10"],
    extractedErrorCodes: ["42000"],
  },
  "https://answers.laserfiche.com/questions/212893/Errors-Processing-Workflow-from-Public-Submission": {
    entryId: "forms-lff502-unexpected-error",
    disposition: "accepted-diagnostic",
    sourceType: "answers-community-confirmed",
    title: "Errors Processing Workflow from Public Submission",
    note: "Reviewed candidate accepted. LFF502 during high-volume public Forms submissions was tied to Workflow service task and routing/concurrency issues; the requester reported no recurrence after resolving the identified issues.",
    reviewStatus: "curated-partial",
    productTags: ["Forms", "Workflow", "Version 11"],
    extractedErrorCodes: ["LFF502"],
  },
  "https://answers.laserfiche.com/questions/181633/Configuring-the-Notification-Service-for-realtime-updates-on-the-Tasks-page": {
    entryId: "forms-lff8100-notification-server-down",
    disposition: "accepted-fix",
    sourceType: "answers-community-confirmed",
    title: "Configuring the Notification Service for real-time updates on the Tasks page",
    note: "Reviewed candidate accepted. Real-time task updates began working after changing the Forms Notification Hub URL from localhost to the machine name and restarting Forms services.",
    reviewStatus: "curated",
    productTags: ["Forms", "Version 10"],
    extractedErrorCodes: ["LFF8100"],
  },
  "https://answers.laserfiche.com/questions/101605/Workflow-Service-Task-Returning-The-remote-server-returned-an-error-401-Unauthorized": {
    entryId: "forms-lff502-unexpected-error",
    disposition: "accepted-diagnostic",
    sourceType: "answers-laserfiche-employee",
    title: "Workflow Service Task Returning: The remote server returned an error: (401) Unauthorized.",
    note: "Reviewed candidate accepted. Laserfiche employee guidance points to Forms/Workflow authentication configuration when a Workflow service task suspends with LFF502 and an inner HTTP 401 Unauthorized response.",
    reviewStatus: "curated-partial",
    productTags: ["Forms", "Workflow", "Version 10"],
    extractedErrorCodes: ["LFF502", "401"],
  },
  "https://answers.laserfiche.com/questions/187125/Forms-Task-Suspended-The-server-is-not-operational": {
    entryId: "forms-lff502-unexpected-error",
    disposition: "accepted-diagnostic",
    sourceType: "answers-community",
    title: "Forms Task Suspended \"The server is not operational\"",
    note: "Reviewed candidate accepted as diagnostic. LFF502 with The server is not operational was investigated against new domain controllers and LDAP changes.",
    reviewStatus: "curated-unresolved",
    productTags: ["Forms", "Version 10"],
    extractedErrorCodes: ["LFF502"],
  },
  "https://answers.laserfiche.com/questions/180800/Forms-Reports-Error-occurred-during-download-Error-500--Solution-Inside": {
    entryId: "forms-reports-download-error-500",
    disposition: "accepted-fix",
    sourceType: "answers-community-confirmed",
    title: "[Forms] Reports: Error occurred during download (Error 500) - Solution Inside",
    note: "Reviewed candidate accepted. [Forms] Reports: Error occurred during download (Error 500) - Solution Inside was promoted from the Forms/Workflow candidate batch.",
    reviewStatus: "curated",
    productTags: ["Forms", "Version 10"],
    extractedErrorCodes: ["500"],
  },
  "https://answers.laserfiche.com/questions/60155/50021-error-when-running-Laserfiche-Forms": {
    entryId: "forms-http-500-21-extensionless-url-handler",
    disposition: "accepted-fix",
    sourceType: "answers-community-confirmed",
    title: "500.21 error when running Laserfiche Forms",
    note: "Reviewed candidate accepted. 500.21 error when running Laserfiche Forms was promoted from the Forms/Workflow candidate batch.",
    reviewStatus: "curated",
    productTags: ["Forms", "Version 9"],
    extractedErrorCodes: ["HTTP 500.21"],
  },
  "https://answers.laserfiche.com/questions/111001/Forms-10-LFF502UnexpectedError": {
    entryId: "forms-lff502-unexpected-error",
    disposition: "accepted-fix",
    sourceType: "answers-community-confirmed",
    title: "Forms 10 LFF502-UnexpectedError",
    note: "Reviewed candidate accepted. The requester resolved Forms 10.1 LFF502 on submission by deleting and recreating the form's date fields.",
    reviewStatus: "curated",
    productTags: ["Forms", "Version 10"],
    extractedErrorCodes: ["LFF502"],
  },
  "https://answers.laserfiche.com/questions/87148/Workflow-Server--The-remote-server-returned-an-error-500": {
    entryId: "forms-workflow-web-service-http-500",
    disposition: "accepted-fix",
    sourceType: "answers-laserfiche-employee",
    title: "Workflow Server - The remote server returned an error 500",
    note: "Reviewed candidate accepted. Workflow Server - The remote server returned an error 500 was promoted from the Forms/Workflow candidate batch.",
    reviewStatus: "curated",
    productTags: ["Forms", "Workflow", "Version 9", "Version 10"],
    extractedErrorCodes: ["500"],
  },
  "https://answers.laserfiche.com/questions/80166/unable-to-view-submission-after-submitting-a-form": {
    entryId: "forms-lff308-page-expired",
    disposition: "accepted-fix",
    sourceType: "answers-community-confirmed",
    title: "unable to view submission after submitting a form",
    note: "Reviewed candidate accepted. Restarting a crashed Forms Routing Service resolved LFF308/PageExpired behavior and allowed queued submissions to come through.",
    reviewStatus: "curated",
    productTags: ["Forms", "Version 9"],
    extractedErrorCodes: ["LFF308"],
  },
  "https://answers.laserfiche.com/questions/180798/Forms-Workflow-Connection-Test-is-improperly-reporting-success": {
    entryId: "forms-lff5206-wf-api-access-denied",
    disposition: "accepted-diagnostic",
    sourceType: "answers-laserfiche-employee",
    title: "Forms Workflow Connection Test is improperly reporting success",
    note: "Reviewed candidate accepted. Laserfiche employee guidance explains that Forms Test Connection is one-way and Workflow-to-Forms connectivity must be tested from Workflow; address mismatch can lead to LFF5206.",
    reviewStatus: "curated-partial",
    productTags: ["Forms", "Workflow", "Version 10"],
    extractedErrorCodes: ["LFF5206"],
  },
  "https://answers.laserfiche.com/questions/57237/Workflow-Subscriber-error-9010": {
    entryId: "workflow-subscriber-9010-incorrect-credentials",
    disposition: "accepted-fix",
    sourceType: "answers-community-confirmed",
    title: "Workflow Subscriber error 9010",
    note: "Reviewed candidate accepted. Workflow Subscriber error 9010 was promoted from the Forms/Workflow candidate batch.",
    reviewStatus: "curated",
    productTags: ["Workflow", "Version 9"],
    extractedErrorCodes: ["9010"],
  },
  "https://answers.laserfiche.com/questions/153873/Error-9051-on-Email-Activity-in-Workflow": {
    entryId: "workflow-9051-email-activity-export",
    disposition: "accepted-diagnostic",
    sourceType: "answers-laserfiche-employee",
    title: "Error 9051 on Email Activity in Workflow",
    note: "Reviewed candidate accepted. Error 9051 on Email Activity in Workflow was promoted from the Forms/Workflow candidate batch.",
    reviewStatus: "curated-unresolved",
    productTags: ["Workflow", "Version 9"],
    extractedErrorCodes: ["9051"],
  },
  "https://answers.laserfiche.com/questions/135957/Workflow-Error-9000": {
    entryId: "workflow-9000-record-series-move-entry",
    disposition: "accepted-fix",
    sourceType: "answers-community-confirmed",
    title: "Workflow Error [9000]",
    note: "Reviewed candidate accepted. Workflow Error [9000] was promoted from the Forms/Workflow candidate batch.",
    reviewStatus: "curated",
    productTags: ["Workflow", "Records Management", "Version 10"],
    extractedErrorCodes: ["9000"],
  },
  "https://answers.laserfiche.com/questions/236900/Failed-to-publish-workflow-MMECMChecksPosted-Object-reference-not-set-to-an-instance-of-an-object-0411WF0": {
    entryId: "workflow-0411-wf0-publish-object-reference",
    disposition: "accepted-fix",
    sourceType: "answers-community-confirmed",
    title: "Failed to publish workflow: Object reference not set to an instance of an object. [0411-WF0]",
    note: "Reviewed candidate accepted. Failed to publish workflow: Object reference not set to an instance of an object. [0411-WF0] was promoted from the Forms/Workflow candidate batch.",
    reviewStatus: "curated",
    productTags: ["Workflow", "Version 12"],
    extractedErrorCodes: ["0411-WF0"],
  },
  "https://answers.laserfiche.com/questions/166472/Forms-Error-Log": {
    entryId: "workflow-lff5203-wf-server-api-fault",
    disposition: "accepted-diagnostic",
    sourceType: "answers-community",
    title: "Forms Error Log",
    note: "Reviewed candidate accepted as diagnostic. LFF5203 reported that Forms could not create a connection to Workflow Server localhost; service restarts got some submissions moving while further investigation continued.",
    reviewStatus: "curated-unresolved",
    productTags: ["Forms", "Workflow", "Version 10"],
    extractedErrorCodes: ["LFF5203"],
  },
